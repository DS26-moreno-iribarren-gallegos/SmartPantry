...
4. Abrir el PR contra `main`, completar la plantilla, incluir `Closes #1` y solicitar revisión a `@DS26-moreno-iribarren-gallegos/reviewers`.
...
`https://github.com/DS26-moreno-iribarren-gallegos/SmartPantry/compare/main...feature/<numero-issue>-<descripcion-corta>?expand=1`
