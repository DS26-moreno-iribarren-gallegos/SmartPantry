...
public class SmartPantry1DomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SmartPantry1GlobalFeatureConfigurator.Configure();
        SmartPantry1ModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SmartPantry1DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SmartPantry1Resource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SmartPantry1");

            options.DefaultResourceType = typeof(SmartPantry1Resource);
        ...
        {
            options.MapCodeNamespace("SmartPantry1", typeof(SmartPantry1Resource));
        });
    }
}
