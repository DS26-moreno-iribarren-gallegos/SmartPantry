...
[DependsOn(
    typeof(SmartPantry1ApplicationTestModule),
    typeof(SmartPantry1EntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class SmartPantry1EntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new SmartPantry1DbContext(new DbContextOptionsBuilder<SmartPantry1DbContext>().UseSqlite(_database.ConnectionString).Options));
